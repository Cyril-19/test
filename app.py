    ...
    if st.button("Capture Image"):
        ...
        if captured_image is not None:
            ...
            if st.button("Retry the Analysis", key="retry_capture"):
                ...
                if st.button("Conform and Continue", key="confirm_new_capture"):
                    question = new_text  # Assume new extracted text is the question
